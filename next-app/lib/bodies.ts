...
export const BODIES: Body[] = [
  ...
  {"code": "it-hojo", "name": "IT導入補助金", "type": "national_agency", "prefecture": null},
  {"code": "monodukuri-hojo", "name": "ものづくり補助金", "type": "national_agency", "prefecture": null},
  {"code": "jigyou-saikouchiku", "name": "事業再構築補助金", "type": "national_agency", "prefecture": null},
  {"code": "jgrants", "name": "Jグランツ", "type": "national_agency", "prefecture": null},
  {"code": "mhlw-careerup", "name": "キャリアアップ助成金", "type": "national_agency", "prefecture": null},
